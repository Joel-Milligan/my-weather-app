...
import React, { MutableRefObject, ReactElement, ReactNode, useCallback, useMemo, useState } from 'react';
...
export function Collapsible(props: Props): ReactElement<Props> {
  ...
  const animatedViewProps = useMemo((): Animated.WithAnimatedObject<ViewProps> => {
